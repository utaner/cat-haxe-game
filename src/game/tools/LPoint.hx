...
class LPoint {
    ...
    inline function get_levelXi()
    return Std.int(levelX);

    /** Level Y pixel coord **/
    public var levelYi(get, never):Int;

    inline function get_levelYi()
    return Std.int(levelY);
    ...
    public inline function setScreen(sx:Float, sy:Float) {
        setLevelPixel((sx - Game.ME.scroller.x) / Const.SCALE, (sy - Game.ME.scroller.y) / Const.SCALE);
        return this;
    }
    ...
    public inline function distCase(?e:BaseEntity, ?pt:LPoint, tcx = 0, tcy = 0, txr = 0.5, tyr = 0.5) {
        if (e != null)
    ...
    public inline function distPx(?e:BaseEntity, ?pt:LPoint, lvlX = 0., lvlY = 0.) {
        if (e != null)
    ...
    public inline function angTo(?e:BaseEntity, ?pt:LPoint, lvlX = 0., lvlY = 0.) {
        if (e != null)
