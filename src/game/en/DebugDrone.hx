...
/**
	This BaseEntity.Entity is intended for quick debugging / level exploration.
	Create one by pressing CTRL-SHIFT-D in game, fly around using ARROWS.
**/
@:access(Camera)
class DebugDrone extends HSpriteEntity {
    public static var ME:DebugDrone;
    static var DEFAULT_COLOR:Col = 0x00ff00 ;

    var ca:ControllerAccess<GameAction>;
    var prevCamTarget:Null<BaseEntity>;
    ...
    public function getSpriteLib() {
        return new SpriteLib([Tile.fromColor(0, 0, 0, 0)]);
    }
